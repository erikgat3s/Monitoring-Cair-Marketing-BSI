...
<center><h2> INFORMASI OUTLET </h2></center>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="/CBS/outlet/process_outlet.php?act=tambah_data" method="post" role="form" enctype="multipart/form-data">
	...
	<table class="table table-bordered" id="myTable">
		...
		<tbody>
			...
			$totalRecordsQuery = mysqli_query($connect, "SELECT COUNT(*) as totalRecords FROM outlet_cbs");
			...
			$sql = "SELECT id_outlet, nama_outlet, target_outlet, photo FROM outlet_cbs";
