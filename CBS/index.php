...
$query    = mysqli_query($connect, "SELECT * FROM marketing_cbs ORDER BY id_marketing");
...
$_SERVER["document_root"] = 'localhost/CBS/';
  ...
  <div class="container" style="margin-top: 150px">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="card-body">
          <a href="#" class="btn" style="" data-toggle="modal" data-target="#tambah_data"><i class="fa fa-male"></i>Input Data</a><br /><br />
          <!-- modal insert -->
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form action="/CBS/proses-tambah.php?act=tambah_data" method="post" role="form">
          ...
          if (isset($_GET['nama'])) {
            ...
            $totalRecordsQuery = mysqli_query($connect, "SELECT COUNT(*) as totalRecords FROM tb_harian_cbs WHERE nama='$nama' AND MONTH(tanggal)='$month' AND YEAR(tanggal)='$year'");
            ...
            $sql = "SELECT * FROM tb_harian_cbs WHERE nama='$nama' AND MONTH(tanggal)='$month' AND YEAR(tanggal)='$year' ORDER BY nama ASC LIMIT $startIndex, $perPage";
          ...
          ?>
            ...
            <table class="table table-bordered" id="myTable">
              ...
              <tbody>
                ...
                $total_realisasi_query = mysqli_query($connect, "SELECT SUM(realisasi_cair) as total_realisasi FROM tb_harian_cbs WHERE nama='$nama' AND MONTH(tanggal)='$month' ORDER BY nama ASC");
                $total_topup_query = mysqli_query($connect, "SELECT SUM(total_topup) as total_topup FROM tb_harian_cbs WHERE nama='$nama' AND MONTH(tanggal)='$month' ORDER BY nama ASC");
