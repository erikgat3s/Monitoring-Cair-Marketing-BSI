...
<title>Leaderboard Cabang CBS</title>
    ...
    <button class="btn btn-success" id="save-page" onclick="hideButtons()">Save Page as Image</button>
        ...
        <div class="container podium">
            ...
            $query = "SELECT outlet_cbs.nama_outlet, 
                ...
                outlet_cbs.photo
                FROM outlet_cbs 
                LEFT JOIN marketing_cbs ON marketing_cbs.nama_outlet = marketing_cbs.nama_outlet 
            ...
            $i = 0;
            $folder_path =  $_SERVER['DOCUMENT_ROOT'] . '/CBS/outlet/photo_kepala_cabang/';
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                if (file_exists($photo_path)) {
                    ...
                    $photo_html = "<img src='http://localhost/CBS/outlet/photo_kepala_cabang/$photo_name' alt='$photo_name' width='100px' height='100px'>";
                } else {
    ...
    <script>
            document.getElementById('save-page').addEventListener('click', function() {
                html2canvas(document.body).then(function(canvas) {
                    ...
                    link.download = 'leaderboard_outlet_cbs_page.png';
                    link.href = imgData;
                    link.click();
