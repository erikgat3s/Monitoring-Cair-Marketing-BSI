...
//  header("Location: /CBS/login/login.php");
//  exit();
//}
				...
				<div class="card-body">
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-body">
										<form action="/CBS/marketing/process_marketing.php?act=tambah_data" method="post" role="form" enctype="multipart/form-data">
												...
												<div class="row">
													...
													<div class="col-sm-8">
														<select name="nama_outlet" class="form-select" aria-label="Default select example" style="width: 100%;" onchange="getTargetOutlet(this.value)">
															...
															$query    = mysqli_query($connect, "SELECT * FROM outlet_cbs ORDER BY id_outlet");
					...
					<table class="table table-bordered" id="myTable">
						...
						<tbody>
							...
							$totalRecordsQuery = mysqli_query($connect, "SELECT COUNT(*) as totalRecords FROM marketing_cbs");
							...
							$marketingQuery = mysqli_query($connect, "SELECT * FROM marketing_cbs JOIN outlet_cbs ON marketing_cbs.nama_outlet = outlet_cbs.nama_outlet LIMIT $startIndex, $perPage");

							if (isset($_GET['sort'])) {
								$sort = $_GET['sort'];
							}
							$sql = "SELECT marketing_cbs.id_marketing, marketing_cbs.nama_marketing, marketing_cbs.target_jabatan, outlet_cbs.nama_outlet, outlet_cbs.target_outlet FROM marketing_cbs
      JOIN outlet_cbs ON marketing_cbs.nama_outlet = outlet_cbs.nama_outlet";
							switch ($sort) {
											...
											<div class="modal fade" id="my<?php echo $id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
												<div class="modal-dialog" role="document">
													<div class="modal-content">
														...
														<div class="modal-body">
															<form action="/CBS/marketing/process_edit_marketing.php" method="POST" role="form" enctype="multipart/form-data">
																<div class="form-group">
																	<div class="row">
																		<label class="col-sm-3 control-label text-right">Nama Marketing<span class="text-red">*</span></label>
																		<div class="col-sm-8">
