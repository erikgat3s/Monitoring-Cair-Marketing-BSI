  ...
  <script src="/assets/html2canvas/html2canvas.min.js" crossorigin="anonymous"></script>
    ...
    <button class="btn btn-success" id="save-page" onclick="hideButtons()">Save Page as Image</button>
        ...
        <div class="container podium">
            ...
            $i = 0;
            $folder_path =  $_SERVER['DOCUMENT_ROOT'] . '/Grafik/login/outlet/photo_kepala_cabang/';
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                if (file_exists($photo_path)) {
                    ...
                    $photo_html = "<img src='http://localhost/Grafik/login/outlet/photo_kepala_cabang/$photo_name' alt='$photo_name' width='100px' height='100px'>";
                } else {
    ...
    <script>
            document.getElementById('save-page').addEventListener('click', function() {
                html2canvas(document.body).then(function(canvas) {
                    ...
                    link.download = 'leaderboard_outlet_cbrm_page.png';
                    link.href = imgData;
                    link.click();
