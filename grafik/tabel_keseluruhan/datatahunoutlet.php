...
if (isset($_POST['submit'])) {
    ...
    (SUM(realisasi_cair) + SUM(total_topup)) AS actual, 
  ...
  FROM outlet 
  LEFT JOIN marketing ON marketing.nama_outlet = outlet.nama_outlet 
  LEFT JOIN tb_harian ON tb_harian.nama = marketing.nama_marketing AND YEAR(tb_harian.tanggal) = YEAR(CURRENT_DATE())
  GROUP BY outlet.nama_outlet 
  ORDER BY actual DESC
            LIMIT 5";
}
