...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $queryupdate = mysqli_query($connect, "UPDATE outlet_cse SET nama_outlet='$outlet', target_outlet='$target_outlet', photo='$photo_name' WHERE id_outlet='$id'");

    if ($queryupdate) {
        header("location: /CSE/outlet");
    } else {
