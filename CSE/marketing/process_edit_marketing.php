...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($_FILES['photo']['name']) {
        ...
        $old_photo_path = "/CSE/marketing/photo_marketing/" . $photo_name;
    ...
    $queryupdate =  mysqli_query($connect, "UPDATE marketing_cse SET nama_marketing='$nama', nama_outlet='$outlet', target_jabatan='$target_jabatan', photo='$photo_name' WHERE id_marketing='$id'" );

    if ($queryupdate) {
        header("location: /CSE/marketing");
    } else {
