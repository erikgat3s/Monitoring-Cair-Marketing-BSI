...
if ($_GET['act'] == 'tambah_data') {
    ...
    //query
    $querytambah =  mysqli_query($connect, "INSERT INTO marketing_cse (nama_marketing, nama_outlet, target_jabatan, photo) VALUES('$nama' , '$outlet' , '$target_jabatan', '$photo_name')");
